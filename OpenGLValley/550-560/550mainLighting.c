...
GLint lightPosLoc, lightColLoc, lightAttLoc, camPosLoc;
camCamera cam;
lightLight myLight;
...
int initializeScene(void) {
    /* Initialize light. */
    lightSetTranslation(&myLight, lightTrans);
    lightSetColor(&myLight, lightCol);
    lightSetAttenuation(&myLight, lightAtt);
    /* Initialize textures. */
...
void render(void) {
    ...
    lightRender(&myLight, lightPosLoc, lightColLoc, lightAttLoc);
